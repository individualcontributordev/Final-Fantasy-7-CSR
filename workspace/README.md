...
workspace/
  ...
  csr/            FINALFANTASY7_D1.bin … (+ .cue), optional .m3u
  csr-plus/       same naming for CSR+
  csr-plusplus/   same naming for CSR++
```

Keep pristine files you never overwrite. Diff with `scripts/bin_diff_to_layer.py` (see `builder/WINDOWS-INSTRUCTIONS.md`).
